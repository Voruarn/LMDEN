...
class LMDEN(nn.Module):
    ...
    def __init__(self, backbone_name='resnet50', mid_ch=128, bottleneck_num=2, **kwargs):
        ...
        self.slmm1=SLMM1(mid_ch)
        self.slmm2=SLMM(mid_ch)
        self.slmm3=SLMM(mid_ch)
        self.slmm4=SLMM(mid_ch)
        self.slmm5=SLMM5(mid_ch)
    ...
    def forward(self, inputs):
        ...
        # SLMM
        ca1=self.slmm1(c1,c2)
        ca2=self.slmm2(c1,c2,c3)
        ca3=self.slmm3(c2,c3,c4)
        ca4=self.slmm4(c3,c4,c5)
        ca5=self.slmm5(c4,c5)
