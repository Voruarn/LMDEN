...
def main():
    ...
    model = eval(opts.model)(mid_ch=opts.mid_ch, backbon_name=opts.backbone)
    ...
    opts.model+='_w'+str(opts.mid_ch)+'_'+opts.backbone
    ...
    for epoch in range(cur_epoch,opts.epochs):
        ...
        for (images, gts) in data_loader:
            ...
            total_loss = loss1 + loss2/2 + loss3/4 +loss4/8 + loss5/16
